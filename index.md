...
### [OOP in Python](./oop-python-guide/oop-guide.html)
...
### [Dotenv Guide](./dotenv-guide/dotenv-guide.html)
...
### [Python Patterns for Data Analysis](./python-patterns/python-patterns.html)
...
- Organised structure instead of chaos
...
*All material authored and maintained by [Monika Tomanek](https://github.com/monikatomanek). Feel free to explore, learn, and link back - but don’t steal. That would be boring.*
